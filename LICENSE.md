...
components that are distributed under their own licenses.
...
You may not do any of the following without explicit written permission from the
copyright holder:
...
This tool is provided without support.

The author(s) have no obligation to provide installation help, bug fixes,
compatibility updates, troubleshooting, save repair, item recovery, or any other
assistance.

## No Warranty

This tool is provided as-is and as-available, with no warranty of any kind.

No guarantee is made that the tool is safe, stable, correct, complete,
compatible, performant, secure, or suitable for any purpose.

## No Future Update Guarantee

The author(s) do not guarantee compatibility with future versions of The
Parasites, Unreal Engine, Windows, drivers, save formats, mod managers, or any
related software.

The tool may stop working at any time.

## Use At Your Own Risk

You are solely responsible for installing and using this tool.

The author(s) are not responsible or liable for any issue caused directly or
indirectly by this tool, including but not limited to:
...
- Game installation damage
- Mod conflicts
- Account, launcher, or platform issues
- Security or system issues
- Any other damage, loss, or inconvenience

Back up your saves before using this tool.

## No Affiliation

This is an unofficial fan-made tool.

It is not affiliated with, endorsed by, sponsored by, or approved by the
developer, publisher, or rightsholder of The Parasites.

## Third-Party Components

This package includes third-party software. Third-party components remain under
their own licenses. These terms do not override third-party license rights or
obligations.

See `THIRD_PARTY_NOTICES.md`, `THIRD_PARTY_NOTICES.txt`, and the files in the
`licenses` folder.

If there is any conflict between these terms and a third-party license, the
third-party license governs that third-party component only.
